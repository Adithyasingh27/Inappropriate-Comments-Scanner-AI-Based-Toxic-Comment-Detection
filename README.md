# ⚠️ Inappropriate Comments Scanner  
...
## 🚀 Features
✔️ Multi-label toxicity detection  
✔️ Bidirectional LSTM model for contextual understanding  
✔️ End-to-end preprocessing pipeline using `TextVectorization`  
✔️ Real-time inference using **Gradio** UI  
✔️ Train/Val/Test pipeline using TF Datasets (cache, shuffle, batch, prefetch)  
✔️ Exportable `.keras` model  
✔️ Scalable design for cloud deployment (AWS/GCP)
...
![Output](https://github.com/user-attachments/assets/7b81131d-c5c9-4e1d-8243-a5bf2e9ce2d4)
